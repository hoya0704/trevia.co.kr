...
<ul class="mainCommon mainLinks">
	<li>
		<h1><a href="http://www.trevia.co.kr/?r=dubai&m=bbs&bid=notice"><img src="/pages/image/main_icon_notice.jpg" alt="트레비아 공지사항" /></a></h1>
	...
	<li>
		<h1><a href="http://www.trevia.co.kr/?r=mexico&m=bbs&bid=resortnews"><img src="/pages/image/main_icon_resortnews.jpg" alt="리조트 소식" /></a></h1>
		<ul class="latestArticle">
	...
	<li class="noMargin">
		<h1><a href="http://www.trevia.co.kr/?r=mexico&m=bbs&bid=epilogue"><img src="/pages/image/trevia_main_travelstory.gif" alt="여행후기 안내" /></a></h1>
		<ul class="latestArticle">
		<?php $infoNotice = getDbArray($table['bbsdata'],"site = 7  AND bbs = 6 AND (bbsid='epilogue' OR bbsid='epilogue') AND notice = 0","uid, subject,site","gid","asc","5","1")?>
		<?php for($i=0; ($infoNotice_element=db_fetch_array($infoNotice)); $i++):?>
			<li><a href="./?r=dubai&m=bbs&uid=<?=$infoNotice_element[uid]?>"><?=$infoNotice_element[subject]?></a></li>
		<?php endfor ?>
		</ul>
