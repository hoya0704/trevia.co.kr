...
<div id="wrap">
	<div id="header">
		...
		<div class="lnb<?php if($my['id']):?> in<?php else:?> out<?php endif?>">
			...
			?>			
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=mexico&c=cancun&uid='.$infoMexico[0].'&list=true'?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="cancun" && $r=="mexico"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_06.jpg" alt="칸쿤" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_06.jpg" class="over" alt="칸쿤" /></a>
			<?php echo $_M1['target']?>
			</li>
			<li>
<!--
	2015-11-11 미주허니문->푸켓 변경, 보라카이 추가				
-->
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=thailand&c=phuket&uid='.$infoThailand1[0]?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="phuket" && $r=="thailand"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_07.jpg" alt="푸켓" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_07.jpg" class="over" alt="푸켓" /></a>
<!--
	2015-11-11 미주허니문삭제 	
...
-->
			...
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=thailand&c=boracay&uid='.$infoThailand4[0]?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="boracay" && $r=="thailand"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_08.jpg" alt="보라카이" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_08.jpg" class="over" alt="보라카이" /></a>
			</li>
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=thailand&c=hawaii&uid='.$infoThailand2[0].'&list=true'?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="hawaii" && $r=="thailand"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_09.jpg" alt="하와이" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_09.jpg" class="over" alt="하와이" /></a>
			</li>
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=indonesia&c=bali&uid='.$infoIndonesia1[0].'&list=true'?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="miju" && $r=="thailand"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_10.jpg" alt="발리" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_10.jpg" class="over" alt="발리" /></a>
			</li>
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=thailand&c=kosamui&uid='.$infoThailand3[0].'&list=true'?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="miju" && $r=="thailand"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_11.jpg" alt="코사무이" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_11.jpg" class="over" alt="코사무이" /></a>
			</li>
			<li>
			<a href="http://www.himaldives.co.kr" target="_blank"><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_12.jpg" alt="몰디브" /></a>
			</li>
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=seychelles&c=seychelles&uid='.$infoSeychelles[0].'&list=true'?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="seychelles" && $r=="seychelles"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_13.jpg" alt="세이셀" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_13.jpg" class="over" alt="세이셀" /></a>
			</li>
			<li>
			<a href="<?php echo $_M1['redirect']?$_M1['joint']:'/?r=mauritius&c=mauritius&uid='.$infoMauritius[0].'&list=true'?>" target="<?php echo $_M1['target']?>"<?php if($_CA[0]=="seychelles" && $r=="seychelles"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_14.jpg" alt="모리셔스" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_14.jpg" class="over" alt="모리셔스" /></a>
...
-->
			...
			<li>
			<a href="<?php echo "/?r=thailand&m=bbs&bid=event"?>" target="<?php echo $_M1['target']?>"<?php if($bid=="event"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_15.jpg" alt="특가&amp;이벤트" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_15.jpg" class="over" alt="특가&amp;이벤트" /></a>
			</li>
			<li>
			<a href="./?r=dubai&amp;mod=trainfomain<?php// echo RW("mod=trainfomain")?>" target="<?php echo $_M1['target']?>"<?php if($bid=="tour"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_16.jpg" alt="항공&anp;여행정보" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_16.jpg" class="over" alt="항공&anp;여행정보" /></a>
			</li>
			<li class="support">
			<a href="<?php echo "/?r=dubai&m=bbs&bid=notice"?>" target="<?php echo $_M1['target']?>"<?php if($bid=="notice"):?> class="over"<?php endif?>><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_17.jpg" alt="고객센터" /><img src="<?php echo $g['img_layout']?>/trevia_top_menu_edit_17.jpg" class="over" alt="고객센터" /></a>
			</li>
			<!--
	...
	<div id="container">
		...
		<div id="content">
			...
			<div class="infobar">
				...
				?>
				<div class="list2">
					<?php /* 2015.02.25 kim hee sung 소스 정리 및 오류 수정 */ ?>
					<div class="wrap">
						<h1><a href="<?php echo RW('m=bbs&bid=notice')?>"><img src="<?php echo "{$g['img_layout']}/header_title_notice.gif";?>" alt="공지사항 타이틀"></a></h1>
						<ul class="notice">
						<?php while($row = mysql_fetch_array($resNotice)):
								
								## 기본설정
								$strUid = $row['uid'];
								$strBbsid = $row['bbsid'];
								$strSubject = $row['subject'];
								$strDRegis = $row['d_regis']; // 등록날짜

								## 제목설정
								$strSubject = getStrCut($strSubject, 29, "...");
								$strDRegisFmt = getDateFormat($strDRegis, 'Y.m.d');

								## 링크 설정
								$strHref = RW("m=bbs&{$strBbsid}&uid={$strUid}");

						?>
						<li><a href="<?php echo $strHref;?>"><span style=""><?php echo $strSubject;?></span> &nbsp; <span style="">[<?php echo $strDRegisFmt;?>]</span></a></li>
						<?php endwhile;?>
						</ul>
					</div>
