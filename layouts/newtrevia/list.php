...
if($cat == "수상비행기" || $R['category'] == "수상비행기" || $R['category'] == "국내선지역")
	$resResort = getDbArray($table['bbsdata'],"bbsid='resort' AND (category = '수상비행기' OR category = '국내선지역')","uid, subject, upload, adddata","uid","desc","","");
// == //
// ==== 프랄린, 마헤 , 라디그
...
<div >
	<div style="margin-top:15px;"><img src="<?php echo $g['s']?>/pages/image/<?=$c?>-best-title.jpg" /></div>
	<ul class="mainCommon">
