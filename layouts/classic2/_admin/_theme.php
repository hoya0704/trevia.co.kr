...
<tr>
<td>
<label class="b"><input type="radio" name="theme" value="<?php echo $_theme?>"<?php if($d['layout']['theme']==$_theme):?> checked="checked"<?php endif?> /><?php echo $_theme?></label><br />
</td>
<td class="t4">
<?php if(!strpos('_blue_gray,blue_white,dark_blue,dark_gray,dark_white,gray_white,white_gray,',$_theme)):?>
