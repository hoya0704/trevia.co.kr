...
$d['layout']['show']['login'] = 0; //로그인폼(출력=1,감춤=0)
$d['layout']['show']['notice'] = 0; //공지사항(출력=1,감춤=0)
$d['layout']['show']['photo'] = 0; //최근사진(출력=1,감춤=0)
$d['layout']['show']['tag'] = 0; //태그(출력=1,감춤=0)
$d['layout']['show']['post'] = 0; //최근게시물(출력=1,감춤=0)
$d['layout']['show']['comment'] = 0; //최근댓글(출력=1,감춤=0)
$d['layout']['show']['archiv'] = 0; //게시물현황(출력=1,감춤=0)
$d['layout']['show']['calendar'] = 0; //칼렌더(출력=1,감춤=0)
$d['layout']['show']['counter'] = 0; //카운터(출력=1,감춤=0)
$d['layout']['show']['rss'] = 0; //RSS(출력=1,감춤=0)
?>