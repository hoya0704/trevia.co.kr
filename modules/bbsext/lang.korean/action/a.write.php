...
if ($uid)
{
	...
	if ($reply == 'Y')
	{
		...
		$QKEY.= "hit,down,comment,oneline,trackback,score1,score2,singo,point1,point2,point3,point4,d_regis,d_modify,d_comment,d_trackback,upload,ip,agent,sns,add1,add2,add3,add4,add5,add6,add7,add8,add9,add10,add11,add12,add13,add14,add15,add16,add17,add18,add19,add20,add21,add22,add23,add24,add25,add26,add27,add28,add29,add30,adddata";
		$QVAL = "'$s','$gid','$bbsuid','$bbsid','$depth','$parentmbr','$display','$hidden','$notice','$name','$nic','$mbruid','$id','$pw','$category','$subject','$content','$html','$tag',";
		$QVAL.= "'0','0','0','0','0','0','0','0','$point1','$point2','$point3','$point4','$d_regis','','','','$upload','$ip','$agent','',";
		$QVAL.= "'$add1','$add2||$add2_12','$add3','$add4','$add5','$add6','$add7','$add8','$add9','$add10','$add11','$add12','$add13','$add14','$add15','$add16','$add17','$add18','$add19','$add20','$add21','$add22','$add23','$add24','$add25','$add26','$add27','$add28','$add29','$add30','$adddata'";
	...
	{	
		...
		if ($my['uid'] != $R['mbruid'] && !$my['admin'] && !strstr(','.($d['bbs']['admin']?$d['bbs']['admin']:'.').',',','.$my['id'].',') && ( $add1 != "" && $add3 != "" && $add4 != "") )
		{
		...
		$QVAL = "display='$display',hidden='$hidden',notice='$notice',pw='$pw',category='$category',subject='$subject',content='$content',html='$html',tag='$tag',point3='$point3',point4='$point4',d_modify='$d_regis',upload='$upload',add1='$add1',add2='$add2||$add2_12',add3='$add3',add4='$add4',add5='$add5',add6='$add6',add7='$add7',add8='$add8',add9='$add9',add10='$add10',add11='$add11',add12='$add12',add13='$add13',add14='$add14',add15='$add15',add16='$add16',add17='$add17',add18='$add18',add19='$add19',add20='$add20',add21='$add21',add22='$add22',add23='$add23',add24='$add24',add25='$add25',add26='$add26',add27='$add27',add28='$add28',add29='$add29',add30='$add30',adddata='$adddata'";

		if( $add1 == "" && $add3 == "" && $add4 == "" && $add5 == "" )
		{
			getLink('','','에러 입니다. - DB가 삭제됩니다. 다시 시도하여 주세요. 현재 상황을 관리자에게 설명하세요','');
		} else {
