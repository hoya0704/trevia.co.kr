...
$m_sql = mysql_query("SELECT * FROM rb_contract_data where uid = '".$_GET[uid]."' ");
$m_rs = mysql_fetch_array($m_sql);

//print_r($m_rs);

$subject = getKRtoUTF($m_rs[subject]);
$name = explode("||", getKRtoUTF($m_rs[name]));
$period = explode("||", getKRtoUTF($m_rs[period]));
$cost = explode("||", getKRtoUTF($m_rs[cost]));
$condition_air = explode("||", getKRtoUTF($m_rs[condition_air]));
$condition_hotel = explode("||", getKRtoUTF($m_rs[condition_hotel]));
$supply = explode("||", getKRtoUTF($m_rs[supply]));
$tel = explode("||", getKRtoUTF($m_rs[tel]));
$email = getKRtoUTF($m_rs[email]);

$puid = $m_rs[puid];

$m_sql = mysql_query("SELECT * FROM rb_bbsext_data where uid = '".$m_rs[puid]."' ");
$m_rs = mysql_fetch_array($m_sql);

//print_r($m_rs);
$add1 = explode("||", $m_rs[add1]);
$add2 = explode("||", getKRtoUTF($m_rs[add2]));
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<table width="800"  border="0" cellspacing="1" cellpadding="0" bgcolor="#545350">
      <tr>
        <td width="100" height="20" align="center" bgcolor="#E6E6E6"><span class="style4"><strong>여행상품명</strong></span></td>
        <td colspan="2" align="center" bgcolor="white"><?=$subject?><input type="hidden" name="val3" value="<?=$subject?>" style="width:150px" /></td>
        <td width="99" align="center" bgcolor="#F1F1F1"><strong>여행기간</strong></td>
        <td width="199" align="center" bgcolor="white"><?=$period[0]?><input type="hidden" name="val4" value="<?=$period[0]?>" style="width:150px" /></td>
        <td width="99" align="center" bgcolor="#F1F1F1"><?=$period[1]?>박<input type="hidden" name="new_val1" value="<?=$period[1]?>" style="width:30px"/></td>
      </tr>

      <tr>
        <td height="20" align="center" bgcolor="#E6E6E6"><span class="style4"><strong>여행자명</strong></span></td>
        <td width="99" align="center" bgcolor="white"><?=$name[0]?><input type="hidden" name="val5" value="<?=$name[0]?>" /></td>
        <td width="199"" align="center" bgcolor="#FFFFFF" ><?=$name[1]?><input type="hidden" name="val6" value="<?=$name[1]?>"  /></td>
        <td bgcolor="white" align="center"><?=$name[2]?><input type="hidden" name="val7" value="<?=$name[2]?>" /></td>
        <td bgcolor="white" align="center"><?=$name[3]?><input type="hidden" name="val8" value="<?=$name[3]?>" /></td>
...
<?if($name[4]) {?>
      <tr>
        <td height="20" align="center" bgcolor="#E6E6E6"><span class="style4"><strong>여행자명</strong></span></td>
        <td width="99" align="center" bgcolor="white"><?=$name[4]?><input type="hidden" name="val9" value="<?=$name[4]?>" readonly="readonly" style="border:0"  /></td>
        <td width="199"" align="center" bgcolor="#FFFFFF" ><?=$name[5]?><input type="hidden" name="val10" value="<?=$name[5]?>" readonly="readonly" style="border:0"  /></td>
        <td bgcolor="white" align="center"><?=$name[6]?><input type="hidden" name="val11" value="<?=$name[6]?>" readonly="readonly" style="border:0"  /></td>
        <td bgcolor="white" align="center"><?=$name[7]?><input type="hidden" name="val12" value="<?=$name[7]?>" readonly="readonly" style="border:0"  /></td>
...
<? } ?>
  ...
  <tr>
    <td><table width="800" border="0" cellspacing="1" cellpadding="0" bgcolor="#545350">
      <tr>
        <td width="130" rowspan="5" align="center" bgcolor="#E6E6E6"><span class="style4"><strong>여행경비</strong></span></td>
        ...
        <td width="143" align="center" bgcolor="#ebf1de"><span class="style4"><strong>항공 요금</strong></span></td>
        <td width="142" align="center" bgcolor="#e6dfec"><span class="style4"><strong>리조트 요금</strong></span></td>
        <td width="142" align="center" bgcolor="#dbe6f1"><span class="style4"><strong>기타비용</strong></span></td>
      </tr>
      <tr>
        <td bgcolor="#F1F1F1" align="center"><span class="style4"><strong>성인</strong></span></td>
        <td height="20" align="center" bgcolor="#ffffff"><?=$cost[0]?><input type="hidden" name="val13" value="<?=$cost[0]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[1]?><input type="hidden" name="val14" value="<?=$cost[1]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[2]?><input type="hidden" name="val15" value="<?=$cost[2]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[3]?><input type="hidden" name="val16" value="<?=$cost[3]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[4]?><input type="hidden" name="val32" value="<?=$cost[4]?>" /></td>
      </tr>
      <tr>
        <td bgcolor="#F1F1F1" align="center"><span class="style4"><strong>소아</strong></span></td>
        <td height="20" align="center" bgcolor="#ffffff"><?=$cost[5]?><input type="hidden" name="val17" value="<?=$cost[5]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[6]?><input type="hidden" name="val18" value="<?=$cost[6]?>" /></td>
        <td width="166" bgcolor="#ffffff" align="center"><?=$cost[7]?><input type="hidden" name="val19" value="<?=$cost[7]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[8]?><input type="hidden" name="val20" value="<?=$cost[8]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[9]?><input type="hidden" name="val33" value="<?=$cost[9]?>" /></td>
      </tr>
      <tr>
        <td bgcolor="#F1F1F1" align="center"><span class="style4"><strong>유아</strong></span></td>
        <td height="20" align="center" bgcolor="#ffffff"><?=$cost[10]?><input type="hidden" name="val21" value="<?=$cost[10]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[11]?><input type="hidden" name="val22" value="<?=number_format($cost[11])?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[12]?><input type="hidden" name="val23" value="<?=number_format($cost[12])?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[13]?><input type="hidden" name="val24" value="<?=number_format($cost[13])?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[14]?><input type="hidden" name="val34" value="<?=number_format($cost[14])?>" /></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#F1F1F1"><span class="style4"><strong>합계</strong></span></td>
        <td height="20" align="center" bgcolor="#ffffff"><?=$cost[15]?> <input type="hidden" name="val25" value="<?=$cost[15]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[16]?> <input type="hidden" name="val26" value="<?=$cost[16]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[17]?> <input type="hidden" name="val27" value="<?=$cost[17]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[18]?> <input type="hidden" name="val28" value="<?=$cost[18]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[19]?> <input type="hidden" name="val35" value="<?=$cost[19]?>" /></td>
      </tr>
      <tr>
        <td bgcolor="#E6E6E6" align="center"><span class="style4"><strong>적용환율</strong></span></td>
        <td bgcolor="#ffffff" align="center"><strong><?=$cost[20]?><input type="hidden" name="new_val29" value="<?=$cost[20]?>" /></strong></td>
        <td bgcolor="#E6E6E6" align="center"><span class="style4"><strong>납부일자 ( T/L )</strong></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[21]?><input type="hidden" name="val29" value="<?=$cost[21]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[22]?><input type="hidden" name="val30" value="<?=$cost[22]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[23]?><input type="hidden" name="val31" value="<?=$cost[23]?>" /></td>
        <td bgcolor="#ffffff" align="center"><?=$cost[24]?><input type="hidden" name="val36" value="<?=$cost[24]?>" /></td>
      </tr>
      <tr>
        <td bgcolor="#E6E6E6" align="center"><span class="style4"><strong>예상 총금액</strong></span></td>
        <td height="20"  align="center" bgcolor="#ffffff"><strong><?=$cost[25]?><input type="hidden" name="ext1" value="<?=$cost[25]?>" /></strong></td>
        <td bgcolor="#f1f1f1" align="center"><strong>원화총액(KRW)</strong></td>
        <td bgcolor="#ffffff" align="center"><strong><?=$cost[26]?><input type="hidden" name="ext2" value="<?=$cost[26]?>" /></strong></td>
        <td bgcolor="#f1f1f1" align="center"><strong>외화총액(<?=$cost[28]?>)</strong><input type="hidden" name="ext4" value="<?=$cost[28]?>" /></td>
        <td bgcolor="#ffffff" align="center"><strong><?=$cost[27]?><input type="hidden" name="ext3" value="<?=$cost[27]?>" /></strong></td>
        <td bgcolor="#ffffff" align="center"></td>
      </tr>
	  <tr>
		<td bgcolor="#E6E6E6" align="center"><span class="style4"><strong>비 고</strong></span></td>
		<td colspan="6"  bgcolor="#ffffff">&nbsp;<input type="hidden" name="val_24" value="<?=$add11[24]?>" /><?=$etc?></td>
	  </tr>
    </table></td>
  </tr>
...
<!--  
  <tr>
    <td height="30"><p><font color="red">* 외화현금결제시 = [ (달러금액 x 송금보낼때 환율)-계약금 ]으로 계산하여 입금.<br>
    </font>[환율기준 : 잔금입금당일 오전 10시 외환은행 전신환(송금보낼때) 기준] < 달러입금시 계약금은 환불됩니다. ><br>
	* 원화 잔금(리조트) 결재 시 계산방법 = (잔금원화 / 적용환율) X 입금당일 전신환</p>    </td>
  </tr>
  <tr>
    <td height='20'>
	<div align='center' class='style14'>[법인 입금 계좌안내]<br/>
	원화계좌 : 신한은행 140-009-270166 주)트레비아 / 주)트레비아 임희성  <br />
	외화계좌 : 신한은행 180-005-629941 TRVIA CO.,LTD / 주)트레비아 임희성 <br />
</div>
</td>
  </tr>
-->
...
if($condition_air[81]) {
	$nrowspan="12";
} else if($condition_air[72]) {
	$nrowspan="11";
} else if($condition_air[63]) {
	$nrowspan="10";
} else if($condition_air[54]) {
	$nrowspan="9";
} else if($condition_air[45]) {
	$nrowspan="8";
} else if($condition_air[36]) {
	$nrowspan="7";
} else if($condition_air[27]) {
	$nrowspan="6";
} else if($condition_air[18]) {
	$nrowspan="5";
} else if($condition_air[9]) {
	$nrowspan="4";
} else if($condition_air[0]) {
	$nrowspan="3";
}
...
?>
	...
	<table width="800" border="0" cellspacing="1" cellpadding="0" bgcolor="#545350">
	  <tr>
        <td colspan="8" rowspan='1<?//=$pcount?>' align="center" bgcolor="#E6E6E6"><span class="style4"><b>항공여정 예약정보</b></span></td>
      </tr>
      <tr>
...
<?$k=0;?>
<? for($i=0;$i<10;$i++):?>
	<?if(!$condition_air[$k]){break;}?>

	<tr>
	 <td bgcolor='#ffffff' align='center'><?=$condition_air[$k]?><input type="hidden" name="nadd<?=$k?>" value="<?=$condition_air[$k++]?>" style="width:70px" /></td>
	 <td bgcolor='#ffffff' align='center'><?=$condition_air[$k]?><input type="hidden" name="nadd<?=$k?>" value="<?=$condition_air[$k++]?>" style="width:70px" /></td>
	 <td bgcolor='#ffffff' align='center'><?=$condition_air[$k]?><input type="hidden" name="nadd<?=$k?>" value="<?=$condition_air[$k++]?>" style="width:70px" /></td>
	 <td bgcolor='#ffffff' align='center'><?=$condition_air[$k]?><input type="hidden" name="nadd<?=$k?>" value="<?=$condition_air[$k++]?>" style="width:70px" /></td>
	 <td bgcolor='#ffffff' align='center'><?=$condition_air[$k]?><input type="hidden" name="nadd<?=$k?>" value="<?=$condition_air[$k++]?>" style="width:70px" /></td>
...
$pcount = 0;
if ($condition_hotel[18]) {
	$pcount = 5;
}elseif ($condition_hotel[12]) {
	$pcount = 4;
}elseif ($condition_hotel[6]) {
	$pcount = 3;
}elseif ($condition_hotel[0]) {
	$pcount = 2;
}
?>
</table>
...
<input type="hidden" name="cnt2" value="<?=$pcount?>" />
      <tr>
        <td colspan="7" rowspan='1<?//=$pcount?>' align="center" bgcolor="#E6E6E6"><span class="style4"><b>숙박시설 예약정보</b></span></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#f1f1f1"><span class="style4"><b>호텔명</b></span></td>
        <td colspan="1" align="center" bgcolor="#f1f1f1"><span class="style4"><b>룸타입</b></span></td>
        <td bgcolor="#f1f1f1" align="center"><span class="style4"><b>체크인</b></span></td>
        <td width="90" bgcolor="#f1f1f1" align="center"><span class="style4"><b>박수</b></span></td>
        <td bgcolor="#f1f1f1" align="center"><span class="style4"><b>체크아웃</b></span></td>
        <td bgcolor="#f1f1f1" align="center"><span class="style4"><b>식사</b></span></td>
        <td colspan="1" align="center" bgcolor="#f1f1f1"><span class="style4"><b>이동수단 </b></span></td>
      </tr>


<?$k=0;?>
<? for($i=0;$i<10;$i++):?>
	<?if(!$condition_hotel[$k]){break;}?>

	<tr>
	 <td align='center' bgcolor='#ffffff'><?=$condition_hotel[$k]?><input type="hidden" name="madd<?=$k?>" value="<?=$condition_hotel[$k++]?>" width="130"/></td>
	<td colspan='1' align='center' bgcolor='#ffffff'><?=$condition_hotel[$k]?><input type="hidden" name="madd<?=$k?>" value="<?=$condition_hotel[$k++]?>" /></td>
	<td bgcolor='#ffffff' align='center'><?=$condition_hotel[$k+3]?><input type="hidden" name="madddata<?=$i?>" value="<?=$condition_hotel[$k+3];$s_date=$condition_hotel[$k+3];$plus_date=$condition_hotel[$k]?>" /></td>
	<td bgcolor='#ffffff' align='center'><?=$condition_hotel[$k]?> 박<input type="hidden" name="madd<?=$k?>" value="<?=$condition_hotel[$k++]?>" /></td>
	<td bgcolor='#ffffff' align="center"><?=$s_date?date("Y-m-d", strtotime($s_date." ". $plus_date." day")):''?></td>
	<td  bgcolor='#ffffff' align='center'><?=$condition_hotel[$k]?><input type="hidden" name="madd<?=$k?>" value="<?=$condition_hotel[$k++]?>" /></td>
	<td colspan='1' align='center' bgcolor='#ffffff'><?=$condition_hotel[$k]?><input type="hidden" name="madd<?=$k?>" value="<?=$condition_hotel[$k++]?>" /></td>
	</tr>
<?$k++?>
<?endfor?>
  ...
  <tr>
    <td><table width="800" border="0" cellpadding="0" cellspacing="1" bgcolor="#545350">
		  <tr>
			...
			<td colspan="6" align="left" bgcolor="#ffffff">&nbsp;&nbsp;<?=$supply[0]?><input type="hidden" name="new_val30" value="<?=$supply[0]?>" />
			</td>
		  </tr>
		  <tr>
			<td height="20" align="center" bgcolor="#E6E6E6" border="0"><span class="style4">기타특전</span></td>
			<td colspan="6" align="left" bgcolor="#ffffff">&nbsp;&nbsp;<?=$supply[1]?><input type="hidden" name="new_val31" value="<?=$supply[1]?>" /></td>
		  </tr>
		  <tr>
			<td height="20" align="center" bgcolor="#E6E6E6" border="0"><span class="style4">비     고</span></td>
			<td colspan="6" align="left" bgcolor="#ffffff">&nbsp;&nbsp;<?=$supply[6]?><input type="hidden" name="new_val32" value="<?=$supply[6]?>" /></td>
		  </tr>
		  </table></td>
   </tr>
   <tr>
   <td><table width="800" border="0" cellpadding="0" cellspacing="1" bgcolor="#545350" >
      <tr>
        <td width="107px" rowspan="2" align="center" bgcolor="#E6E6E6"><span class="style4">항목</span></td>
...
영업보증보험 [금액 : 2 억원] / 피보험자 : 주)트레비아 </div></td>
        <td bgcolor="#ffffff" align="center"><input type="text" name="val44" value="<?=$supply[2]?>" style="width:60px; border:0; border-bottom-style:none;" /></td>
        <td bgcolor="#ffffff" align="center"><input type="text" name="val45" value="<?=$supply[3]?>" style="width:60px; border:0; border-bottom-style:none;" /></td>
        <td align="center" bgcolor="#ffffff"><input type="text" name="val46" value="<?=$supply[4]?>" style="width:60px; border:0; border-bottom-style:none;" /></td>
        <td align="center" bgcolor="#ffffff"><input type="text" name="val47" value="<?=$supply[5]?>" style="width:60px; border:0; border-bottom-style:none;" /></td>
      </tr>
    </table></td>
  </tr>
    <tr>
...
드립니다.(예약 확정 까지는 최대 3~4일이 소요될 수 있습니다.) </span></td>
  ...
  <tr>
    <td><table width="800" border="0" cellpadding="0" cellspacing="1" bgcolor="#545350">
      <tr>
        <td width="100" height="25" align="center" bgcolor="#e6e6e6"><span class="style4"><b>상 호 </b></span></td>
        <td width="290" align="center" bgcolor="#ffffff"><span class="style4">주식회사 트레비아 </span></td>
        ...
        <td width="169" align="center" bgcolor="#ffffff"><?=$tel[0]?><input type="hidden" name="val48" value="<?=$tel[0]?>" style="width:150px" /></td>
      </tr>
      <tr>
        ...
        <td align="center" bgcolor="#ffffff"><?=$tel[1]?><input type="hidden" name="val49" value="<?=$tel[1]?>" /></td>
      </tr>
      <tr>
...
?>
  ...
  <tr>
    <td>&nbsp;
	<input type="hidden" name="val51" value="<?=$tel[3]?>" />
	<input type="hidden" name="val52" value="<?=$tel[4]?>" />
	<input type="hidden" name="val53" value="<?=$tel[5]?>" />
	<input type="hidden" name="val53_1" value="<?=$email?>" />
	<input type="hidden" name="val54" value="<?=$tel[6]?>"/>
	<input type="hidden" name="val55" value="<?=$tel[7]?>" />
	<input type="hidden" name="val56" value="<?=$tel[8]?>"  />
	<input type="hidden" name="val56_1" value=""/>
	</td>
  </tr>
  <tr>
    <td><table width="800" border="0" cellspacing="1" cellpadding="0" bgcolor="#545350">
      <tr>
        <td width="100" rowspan="2"  align="center" bgcolor="#e6e6e6"><span class="style4"><b>성 명</b></span></td>
        <td width="210" height="25" align="center" bgcolor="#ffffff"><?=$tel[3]?></td>
        <td width="140" align="center" bgcolor="#ffffff"><?=$tel[4]?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#aaa">(서명)</span></td>
        <td width="100" rowspan="1"  align="center" bgcolor="ffffff"><?=$tel[5]?></td>
        <td width="169" align="center" bgcolor="#ffffff"><?=$email?></td>
      </tr>
      <tr>
        <td height="25" align="center" bgcolor="#ffffff"><?=$tel[6]?></td>
        <td align="center" bgcolor="#ffffff"><?=$tel[7]?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#aaa">(서명)</span></td>
        <td width="100" rowspan="1"  align="center" bgcolor="ffffff"><?=$tel[8]?></td>
...
② 특수지역에의 여행으로서 정당한 사유가 있는 경우에는 당사의 여행약관의 내용과 달리 정할 수 있습니다.
  ...
  <tr>
    <td height="20"><span class="style4"><strong>[ 특별 여행약관 : <?=$period[2]?> ] </strong></span></td>
  </tr>
  <tr>
    <td>
	</td>
...
1. 본 상품은 <?=$period[2]?> 여행 상품으로 리조트와 항공권 등이 포함된 상품입니다.
...
2. 주식회사 트레비아에서는 최대 보험금 1억원의 여행자 보험을 가입해 드립니다. 여행 도중에 우연하게 현지에서 발생하는 불의의 사고 및 질병이 발생할 경우에는 반드시 현지 가이드 및 회사 긴급 연락처에 연락하여 도움을 받으시길 바랍니다. 보험 약관상 현지 병원 진단서 및 영수증, 경찰의 사건 확인서를 받아 오셔야 보험 혜택이 있으므로 가이드와 상의 바랍니다. 보험 약관에 관한 자세한 혜택 내용은 홈페이지(www.samsungfire.co.kr)를 통하여 확인하여 주시기 바랍니다.
  ...
  <tr>
    <td height="40"><p class="style4"><strong>본인 <?=$name[0]?><?if($name[2]):?>과 <?=$name[2]?><?endif?>는 상기 첨부된 여행계약서 내용을 충분히 검토하여 이의 없음을 확인하고 전원이 동의한다는 의사표시로써 본인 및 동행자의 서명, 날인에 갈음하여 e-mail로 회신합니다. 회신자 <?=$name[0]?> <?=$name[2]?> [<?=date('Y년m월d일 H시i분s초')?>] <br>
    </strong></p>    </td>
  </tr>
  <tr>
	<td>&nbsp;</td>
    ...
    <td height="20">
      <div align='right'>
          <b><font size='3' color='red'>
				<input type='button' name='sending' value=' 여행 계약 승인 ' style='width:200px;height:40px' />
			</font></b>
		  </div>
	</td>
  </tr>
...
<?
$admin_name = explode("||", $m_rs[tel]);

$m_sql1 = mysql_query("SELECT * FROM rb_s_mbrdata where name like '%".$admin_name[0]."%' ");
$m_rs1 = mysql_fetch_array($m_sql1);

?>

<div style="width:400px;">
받은 메일 주소(고객) : <?=$email?>, <input type="text" name="add_email" /><br>
받은 메일 주소(추가발송, 관리자) : ok@trevia.co.kr, <?=$m_rs1[email]?><br>
<input type="hidden" name="admin_add_email" value="<?=$m_rs1[email]?>" />
</div>
<br/>
<input type="hidden" name="xms" id="xms" value="mms" />
<input type="hidden" name="myuid" id="myuid" value="<?=$my['uid']?>" />
<input type="hidden" name="memberuid" id="memberuid" value="<?=$my['uid']?>" />
<input type="hidden" name="uid" id="uid" value="<?=$puid?>" />
<input type="hidden" name="r" id="r" value="<?=$r?>" />
<input type="hidden" name="m" id="m" value="<?=$m?>" />
<input type="hidden" name="bid" id="bid" value="<?=$bid?>" />
<input type="hidden" name="receiver" id="receiver" value="<?=$add3[4]?>" />
<input type="hidden" name="smsText" id="smsText" value="트레비아에서 여행계약서를 이메일과 모바일로 전송하였습니다.http://trevia.co.kr/modules/bbsext/theme/_pc/list02/mobile.php?puid=<?=$puid?>" />
<input type="hidden" name="custom_number" value="02-1644-6681" class="addInput" /><br />
<table width="100%" style="display:none">
	<tr><td valign="top">문자전송 수신번호 : 
	<? $k=0; ?>
	<? for($i=0;$i<10;$i++):?>
		<?if($i>0&&!$add3[$k+4]):?>
		<?else:?>
			<input type="hidden" value="<?=$add3[$k+4]?>" name="send_tel_<?=$i?>" style="width:90px;border:0; border-bottom-style:none;" />
		<?endif?>
		<? $k = $k + 6; ?>
	<?endfor?>
	</td></tr>
...
<input type="button" name="sending" value="메일 재전송" style="width:200px;height:40px" onclick="document.form.submit();" />
<input type="button" name="printing" value="프린트" style="width:90px;height:40px" onclick="window.print();" />
