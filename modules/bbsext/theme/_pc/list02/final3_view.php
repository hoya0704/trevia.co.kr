...
<table width="800" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border-color:#f0f0f0; margin-top:50px;">
<colgroup>
...
<div style="float:left;width:800px;text-align:right; margin-top:30px;">
<form id="form" name="form" action="/modules/bbsext/theme/_pc/list02/final3_modify.php" method="post" onsubmit="return false" >
<input type="hidden" name="admin_add_email" value="<?=$_GET[admin_add_email]?>" />
<input type="hidden" name="uid" value="<?=$uid?>" />
<input type="hidden" name="auto_sending" value="true" />
추가이메일
<input type="text" name="addemail" style="width:160px;height:30px" />&nbsp;&nbsp;&nbsp;
<input type="button" name="resend" value="견적서 재발송" style="width:120px;height:40px"
	onclick="document.form.submit();" />
<!-- location.href='/modules/bbsext/theme/_pc/list02/final3_modify.php?uid=<?=$uid?>&auto_sending=false' -->
<input type="button" name="modify" value="견적서 수정" style="width:120px;height:40px" onclick="location.href='/modules/bbsext/theme/_pc/list02/final3_modify.php?uid=<?=$uid?>&ins=true&admin_add_email=<?=$_GET[admin_add_email]?>'" />
<input type="button" name="print" value="인쇄" style="width:60px;height:40px" onclick="window.print();" />
