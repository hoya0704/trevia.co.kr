...
<!--
document.title ="<?=$add3[1]?>님의 <?=$add2[2]?> <?=$add2[4]?> <?=$add2[5]?>박 <?=$add2[10]?>일 여행계약서";
-->
</script>
  ...
  <tr>
	...
	<table width="800"  border="0" cellspacing="1" cellpadding="0" bgcolor="#545350">
      <tr>
        ...
        <td width="199" align="center" bgcolor="white"><?=$add2[7]?> ~ <?=$add2[8]?><input type="hidden" name="val4" value="<?=$add2[7]?> ~ <?=$add2[8]?>" style="width:150px" /></td>
        <td width="99" align="center" bgcolor="#F1F1F1"><?=$add2[5]?>박 <?=$add2[10]?>일<input type="hidden" name="new_val1" value="<?=$add2[5]?>박 <?=$add2[10]?>일" style="width:30px"/></td>
      </tr>

      <tr>
        <td height="20" align="center" bgcolor="#E6E6E6"><span class="style4"><strong>여행자명</strong></span></td>
        <td width="99" align="center" bgcolor="white"><?=$add3[1]?><input type="hidden" name="val5" value="<?=$add3[1]?>" /></td>
        <td width="199"" align="center" bgcolor="#FFFFFF" ><?=$add3[2]?><input type="hidden" name="val6" value="<?=$add3[2]?>"  /></td>
...
<?if($add3[13]) {?>
      <tr>
        <td height="20" align="center" bgcolor="#E6E6E6"><span class="style4"><strong>여행자명</strong></span></td>
        <td width="99" align="center" bgcolor="white"><?=$add3[13]?><input type="hidden" name="val9" value="<?=$add3[13]?>" readonly="readonly" style="border:0"  /></td>
        <td width="199"" align="center" bgcolor="#FFFFFF" ><?=$add3[14]?><input type="hidden" name="val10" value="<?=$add3[14]?>" readonly="readonly" style="border:0"  /></td>
...
?>
	  ...
	  <tr>
		...
		<td colspan="6"  bgcolor="#ffffff">&nbsp;<input type="text" name="val_24" value="<? if(empty($add11[24]) ) {?>*상기 예상 총금액은 환율 변동에 따라 잔금시점에 금액변동 될 수 있습니다.<?} else { echo $add11[24]; }?>" style="width:500px; border:0; border-bottom-style:none;"/></td>
	  </tr>
    </table></td>
  </tr>
<tr>
...
// 계약 승인 확인
function goTravelContractRequest()
{
  ...
  <tr>
    <td><table width="800" border="0" cellpadding="0" cellspacing="1" bgcolor="#545350">
		  ...
		  <tr>
			<td height="20" align="center" bgcolor="#E6E6E6" border="0"><span class="style4">허니문 특전</span></td>
			<td colspan="6" align="left" bgcolor="#ffffff">&nbsp;&nbsp;허니문특전은 리조트에서 제공해드리는 특전으로 도착시점에 리조트의 사정에 의해 사전통보 없이 일부 변경될 수 있습니다. <br>&nbsp;&nbsp;리조트 체크인시에 확인해 주시기 바랍니다. </td>
		  </tr>
		  </table></td>
   </tr>
   <tr>
...
영업보증보험 [금액 : 2 억원] / 피보험자 : 주)트레비아
	...
	<tr>
        ...
        <td colspan="9" align="left" bgcolor="#f1f1f1"><span class="style4"><b>상기 여행자보험 보장내역은 LIG 해외여행보험기준입니다.<br/> 기타 여행자보험 상품 가입 시 보장내역은 상품에 따라 상이할 수 있습니다.</b></span>
		<br><b style="color:red">출발 일주일 전 까지 여권사본 미 제출시에는 여행자보험이 가입 되지 않으며, 여행자보험 개별진행으로 간주되오니 불이익 당하시지 않도록 출발 일주일 전 까지 여권사본 꼭! 제출 바랍니다.</b>
		</td>
      </tr>      
    </table></td>
  </tr>
...
드립니다.(예약 확정 까지는 최대 3~4일이 소요될 수 있습니다.)</span></td>
  ...
  <tr>
    <td><table width="800" border="0" cellpadding="0" cellspacing="1" bgcolor="#545350">
      <tr>
        <td width="95" height="25" align="center" bgcolor="#e6e6e6"><span class="style4"><b>상 호 </b></span></td>
        ...
        <td width="169" align="center" bgcolor="#ffffff"><?=$add2[9]?><input type="hidden" name="val48" value="<?=$add2[9]?>" style="width:100px; border:0; border-bottom-style:none;align:center"/></td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table width="800" border="0" cellspacing="1" cellpadding="0" bgcolor="#545350">
      <tr>
        ...
        <td width="210" height="25" align="center" bgcolor="#ffffff"><?=$add3[0]?>.<?=$add3[2]?></td>
        <td width="140" align="center" bgcolor="#ffffff"><?=$add3[1]?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#aaa">(서명)</span></td>
        <td width="100" rowspan="1"  align="center" bgcolor="#ffffff"><?=$add3[4]?></td>
        <td width="169" align="center" bgcolor="#ffffff"><?=$add3[5]?></td>
      </tr>
      <tr>
        ...
        <td width="100" rowspan="1"  align="center" bgcolor="#ffffff"><?=$add3[10]?></td>
...
받은 메일 주소(추가발송, 관리자) : ok@trevia.co.kr, <?=$m_rs[id]?><br>
