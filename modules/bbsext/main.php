...
## 2015.02.16 kim hee sung, 뷰페이지에서 목록으로 이동시, 검색된 내용 그대로 이동하기 위해 추가
if($bid == 'cus_manager2')
	$g['bbs_list']  = "{$g[bbs_list]}&admin_email={$admin_email}&sort_kind={$sort_kind}&reception={$reception}&start_duration={$start_duration}&end_duration={$end_duration}&recnum={$recnum}&search_travel={$search_travel}";
