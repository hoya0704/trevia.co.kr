...
<div id="pages_join">
	...
	<td>
		<div class="desc">비밀번호를 한번 더 입력하세요. 비밀번호는 잊지 않도록 주의하시기 바랍니다.</div>
	</td>
	</tr>
	...
	<td>
		<div class="desc">예약처리에 따른 경과를 문자로 알려드립니다.</div>
	</td>
	</tr>
	<?php endif?>
	...
	<td>
		<div>여행안내서, 계약서, 지급사은품 등의 발송용 주소정보가 필요합니다.</div>
	</td>
	</tr>
	<?php endif?>

	<tr>
	<td class="key">알림설정</td>
	<td>
	...
	<td>
		<div class="desc">견적서 수신 빛 여행정보, 공지를 수신합니다.</div>
	</td>
	</tr>
	...
	<?php if($d['member']['form_sns_1']||$d['member']['form_sns_2']||$d['member']['form_sns_3']||$d['member']['form_sns_4']):?>
	<?php $SNSSET=array('트위터','페이스북','미투데이','요즘')?>
	<tr>
	<td class="key">SNS 아이디</td>
	<td>
		<?php for($i = 0; $i < 4; $i++):?>
		<input type="text" name="sns_<?php echo $i?>" value="" class="input" /> - <?php echo $SNSSET[$i]?><br /> 
		<?php endfor?>
	</td>
	</tr>
	<?php endif?>
