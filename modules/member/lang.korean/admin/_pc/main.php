...
<div id="mbrlist">
	...
	<div class="sbox">
		...
		<select name="where">
		<option value="email"<?php if($where=='email'):?> selected="selected"<?php endif?>>아이디</option>
...
<?php endif?>
	...
	<div class="prebox">
		...
		<input type="button" class="btngray" value="문자" onclick="actQue('sms');" />
		...
		<div id="span_member_sms" class="xt1 hide">

		<textarea name="sms" rows="8" cols="60" class="textarea"></textarea><br />

		<input type="button" class="btnblue" value="보내기" onclick="actQue('send_sms');" />
...
function actQue(flag)
{
	...
	if (flag == 'tool' || flag == 'give' || flag == 'paper' || flag == 'email' || flag == 'dump' || flag == 'sms')
	{
		...
		getId('span_member_sms').style.display = 'none';
