...
<div id="pages_login">
	...
	<div class="agreebox">
		...
		<table>
			...
			<td>
				<input type="text" name="id" class="input xinput" value="<?php echo getArrayCookie($_COOKIE['svshop'],'|',0)?>" />
			</td>
			</tr>
			<tr>
			<td class="key">비밀번호</td>
			<td>
				<input type="password" name="pw" class="input xinput" value="<?php echo getArrayCookie($_COOKIE['svshop'],'|',1)?>" />
			</td>
			</tr>
			<tr>
			<td class="key"></td>
