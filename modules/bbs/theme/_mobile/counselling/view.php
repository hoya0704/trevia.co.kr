	...
	<div class="viewbox">
		...
		<!-- 추가내용 -->
			...
			<table cellspacing="0" border="0">
				...
				<td class="td2 topBorder2" colspan="3"><?php echo $R['name']?></td>
				</tr>
				<tr>
				...
				<td class="td2" colspan="3"><?php echo $adddata['cellphone1']?> - <?php echo $adddata['cellphone2']?> - <?php echo $adddata['cellphone3']?></td>
				</tr>
				<tr>
