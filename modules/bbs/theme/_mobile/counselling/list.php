<div id="bbslist">
	...
	<td class="confirm">대기</td>
	<td class="hit b"><?php echo $R['hit']?></td>
	<td><?php echo getDateFormat($R['d_regis'],'Y년 m월')?></td>
	</tr> 
	<?php endforeach?> 
	...
	<?php $infoConfirm2 = getDbData("rb_bbs_confirm","bbsdatauid='".$R['uid']."'","*");?>
	<td class="confirm"><?php if(is_array($infoConfirm2)):?>접수<?php else:?>대기<?php endif?></td>
	<td class="hit b"><?php echo $R['hit']?></td>
	<td><?php echo getDateFormat($R['d_regis'],'Y년 m월')?></td>
	</tr> 
	<?php endforeach?> 
