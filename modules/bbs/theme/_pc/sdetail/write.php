<div id="bbswrite">
	...
	<table>
		...
		<td class="td1">항공편</td>
		<td class="td2">
			<input type="text" name="adddata[airline]" value="<?php echo urldecode($adddata['airline'])?>" class="input" />
		</td>
		</tr>
		<tr>
		<td class="td1">직항</td>
		<td class="td2">
			<input type="text" name="adddata[direct]" value="<?php echo urldecode($adddata['direct'])?>" class="input" />
		</td>
		</tr>
		<tr>
		<td class="td1">일정</td>
		<td class="td2">
			<input type="text" name="adddata[days]" value="<?php echo urldecode($adddata['days'])?>" class="input" />
		</td>
		</tr>
		<tr>
		<td class="td1">일정상세</td>
		<td class="td2">
