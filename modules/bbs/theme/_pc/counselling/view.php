<div id="bbsview">
	...
	<div class="viewbox">
		...
		<!-- 추가내용 -->
			<div id="bbswrite" class="view">
			<table cellspacing="0" border="0">
				<tr>
				<td class="td1 topBorder1"><img src="<?php echo $g['img_module_skin']?>/lbl_name.gif" alt="고객명" /></td>
				<td class="td2 topBorder2" colspan="1"><?php echo $R['name']?></td>
				<td class="td1 topBorder1">IP</td>
				<td class="td2 topBorder2" colspan="1"><?php echo $R['ip']?>&nbsp;&nbsp;&nbsp;<a href="/modules/bbs/lang.korean/action/a.block_ip.php?uid=<?=$R[uid]?>&ip=<?=$R[ip]?>&name=<?=$my[name]?>&bbsid=<?=$R[bbsid]?>$r=<?=$_GET[r]?>&m=<?=$_GET[m]?>">차단요청</a></td>
				</tr>
				<tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_email.gif" alt="이메일" /></td>
				<td class="td2"><a href="mailto:<?php echo urldecode($adddata['email'])?>"><?php echo urldecode($adddata['email'])?></a></td>
				<td class="td3"><img src="<?php echo $g['img_module_skin']?>/lbl_region.gif" alt="여행지역" /></td>
				<td class="td2"><?php echo urldecode($adddata['region'])?></td>
				</tr>
				<tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_cp.gif" alt="휴대폰" /></td>
				<td class="td2" colspan="1"><?php echo $adddata['cellphone1']?> - <?php echo $adddata['cellphone2']?> - <?php echo $adddata['cellphone3']?></td>
				<td class="td1">제휴사코드</td>
				<td class="td2" colspan="1"><?php echo $adddata['Affiliates']?></td>
				</tr>
				<tr>
				<td class="td1"><img src="http://trevia.co.kr<?php echo $g['img_module_skin']?>/lbl_kind.gif" alt="여행종류" /></td>
				<td class="td2" colspan="3"><?php echo urldecode($adddata['kind'])?></td>
				</tr>
				<tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_person_count.gif" alt="총 여행인원" /></td>
				<td class="td2" colspan="3"><?php echo urldecode($adddata['person_count'])?></td>
				</tr>
				<tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_start_date.gif" alt="출발날짜" /></td>
				<td class="td2"><?php echo $adddata['start_date']?></td>
				<td class="td3"><img src="<?php echo $g['img_module_skin']?>/lbl_scheduled.gif" alt="예정" /></td>
				<td class="td2"><?php echo urldecode($adddata['scheduled'])?></td>
				</tr>
			</table>
			...
			<table cellspacing="0" border="0">
				...
				<td class="td2 topBorder2"><?php echo $adddata['budget']?></td>
				<td class="td3 topBorder2"><img src="<?php echo $g['img_module_skin']?>/lbl_wish_time.gif" alt="상담 희망시간" /></td>
				<td class="td2 topBorder2"><?php echo urldecode($adddata['wish_time1'])?> ~ <?php echo urldecode($adddata['wish_time2'])?></td>
				</tr>
				<tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_airline.gif" alt="희망 항공사" /></td>
				<td class="td2"><?php echo urldecode($adddata['airline'])?></td>
				<td class="td3"><img src="<?php echo $g['img_module_skin']?>/lbl_fax.gif" alt="팩스번호" /></td>
				<td class="td2"><?php echo $adddata['fax1']?> - <?php echo $adddata['fax2']?> - <?php echo $adddata['fax3']?></td>
				</tr>
				<tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_resort.gif" alt="희망리조트" /></td>
				<td class="td2" colspan="3"><?php echo urldecode($adddata['wish_resort1'])?>,<?php echo urldecode($adddata['wish_resort2'])?>,<?php echo urldecode($adddata['wish_resort3'])?></td>
				</tr>
				<td class="td1"><img src="<?php echo $g['img_module_skin']?>/lbl_etc_requirement.gif" alt="기타 요청사항" /></td>
				<td class="td2" colspan="3"><?php echo getContents($R['content'],$R['html'])?></td>
				</tr>
			</table>
			</div>
			<!-- / 추가내용 -->
			...
			<!-- 접수 확인 기능 -->
			<?php
			$infoConfirm = getDbData("rb_bbs_confirm","bbsdatauid='".$uid."'","*");
			$cfmmbr = getDbData("rb_s_mbrdata","memberuid='".$infoConfirm['memberuid']."'","name");
			?>
			<?php if(is_array($infoConfirm)):?>
			<ul>
				<li><b><?php echo $cfmmbr['name']?></b>님께서 <b><?php echo getDateFormat($infoConfirm['d_regis'],"Y-m-d H:i:s")?></b>에 접수 승인하셨습니다.</li>
			</ul>
			<?php endif?>
			<!-- / 접수 확인 기능 -->
	...
	<div class="bottom">
		<?php if(!is_array($infoConfirm)):?>
		<span class="btn00"><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&m=bbs&bid=<?php echo $bid?>&a=confirm&uid=<?php echo $uid?>" target="_action_frame_<?php echo $m?>">접수</a></span>
		<?php endif?>
