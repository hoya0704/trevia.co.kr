...
$d['theme']['show_upfile'] = "0"; //첨부파일출력(출력=1/감춤=0)
...
//글쓰기
$d['theme']['edit_html'] = "100"; //위지위그에디터 사용등급(레벨넘버이상,0이면 비회원허용)
$d['theme']['edit_height'] = "100"; //글쓰기폼높이(픽셀)
$d['theme']['show_edittool2'] = "0"; //편집기아이콘출력(출력=1/감춤=0)
$d['theme']['perm_upload'] = "0"; //파일첨부권한(등급이상)
$d['theme']['perm_photo'] = "0"; //사진첨부권한(등급이상)
