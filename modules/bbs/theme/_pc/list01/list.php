<div id="bbslist">
	...
	<div class="info">
		...
		<div class="category">
			...
			<!-- 통합 트레비아 임시 조치 -->
			<?php if($r!="maldives" && $bid!="notice"):?>
			<img src="<?php echo $g['img_module_skin']?>/select_sitecode.gif" align="absmiddle" />
			<select onchange="location.href='<?php echo $g['s']?>/?r='+this.value+'&m=bbs&bid=<?php echo $bid?>&sel=' + this.value">
				<option value="mexico"<?php if($_GET['sel']=="mexico"):?> selected="selected"<?php endif?>>멕시코(칸쿤)</option>
				<option value="rivieramaya"<?php if($_GET['sel']=="rivieramaya"):?> selected="selected"<?php endif?>>리비에라마야</option>
				<option value="miju"<?php if($_GET['sel']=="miju"):?> selected="selected"<?php endif?>>미주허니문</option>
				<option value="hawaii"<?php if($_GET['sel']=="hawaii"):?> selected="selected"<?php endif?>>하와이</option>
<!--
				<option value="dubai"<?php if($r=="dubai"):?> selected="selected"<?php endif?>>두바이(두바이)</option>
				<option value="thailand"<?php if($r=="thailand"):?> selected="selected"<?php endif?>>태국(코사무이)</option>
				<option value="indonesia"<?php if($r=="indonesia"):?> selected="selected"<?php endif?>>인도네시아</option>
				<option value="seychelles"<?php if($r=="seychelles"):?> selected="selected"<?php endif?>>세이쉘(세이쉘)</option>
-->
			</select>
			<?php endif?>
			<!-- / 통합 트레비아 임시 조치 -->
