<div id="bbslist">
	...
	<div class="info">
		...
		<div class="category">
			...
			<select onchange="location.href='<?php echo $g['s']?>/?r='+this.value+'&m=bbs&bid=<?php echo $bid?>'">
				<option value="mexico"<?php if($r=="mexico"):?> selected="selected"<?php endif?>>멕시코(칸쿤)</option>
	...
	<td class="sbj">
		...
		$linkheader = $adddata['linkheader'];
		$linkurl = urldecode($adddata['linkurl']);
		?>
		<?php if(!empty($linkurl)):?>
			<a href="<?php echo $linkurl?>" target="_blank"><img src="<?php echo $g['img_module_skin']?>/icon_<?php echo $linkheader?>.gif" /></a>
		<?php endif?>
