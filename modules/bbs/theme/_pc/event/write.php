<div id="bbswrite">
	...
	<table>
		...
		<tr>
		<td class="td1">이벤트제목</td>
		<td class="td2">
			<input type="text" name="adddata[subject]" value="<?php echo $adddata['subject']?>" class="input subject" />
		</td>
		</tr>
		...
		<td class="td1">설명</td>
		<td class="td2">
			<textarea name="adddata[desc]"><?php echo $adddata['desc']?></textarea>
		</td>
		</tr>
		...
		<td class="td1">기간</td>
		<td class="td2">
			<input type="text" name="adddata[dateStart]" value="<?php echo $adddata['dateStart'] ? $adddata['dateStart'] : date("Y-m-d")?>" class="input" />
			~
			<input type="text" name="adddata[dateEnd]" value="<?php echo $adddata['dateEnd'] ? $adddata['dateEnd'] : date("Y-m-d")?>" class="input" /> (2011-11-12)
		</td>
		</tr>
		<tr>
		<td class="td1">메인노출</td>
		<td class="td2">
			<input type="checkbox" name="notice" value="1"<?php if( $R['notice'] ) {?>checked<? }?>>
		</td>
		</tr>
	...
	<div class="bottombox">
		...
		<input type="submit" id="btnSubmit" value="확인" class="btnblue" />
	</div>
