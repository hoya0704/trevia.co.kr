<div id="bbslist">
	...
	<?php $mainPrint = array("","","[New]","[Promotion]","[Best]");?>
	<td class="sbj">
	...
	<div class="bottom">
		<div class="btnbox1">
		<?php if($B['uid']):?><span class="btn00"><a href="<?php echo $g['bbs_write']?>&k=copy&uid=">글쓰기</a></span><?php endif?>
		</div>
		<div class="btnbox2">
