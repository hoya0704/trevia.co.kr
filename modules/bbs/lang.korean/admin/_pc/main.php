		...
		<table>
			...
			<tr>
				...
				<td class="td2 shift">
					...
					<img src="<?php echo $g['img_core']?>/_public/ico_under.gif" alt="접기/펼치기" title="접기/펼치기" id="dm_img_config" class="dm" onclick="codShowHide('menu_config','block','none',this);" /><br />
