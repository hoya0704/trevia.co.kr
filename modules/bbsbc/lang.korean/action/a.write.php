...
$add_txt1	= trim($add_txt1);
$add_txt2	= trim($add_txt2);
$add_txt3	= trim($add_txt3);
$add_txt4	= trim($add_txt4);
$add_txt5	= trim($add_txt5);
$add_txt6	= trim($add_txt6);
$add_txt7	= trim($add_txt7);
$add_txt8	= trim($add_txt8);
$add_txt9	= trim($add_txt9);
$add_txt10	= trim($add_txt10);
$add_txt11	= trim($add_txt11);
$add_txt12	= trim($add_txt12);
$add_txt13	= trim($add_txt13);
...
if ($uid)
{
	...
	if ($reply == 'Y')
	{
		...
		$QKEY.= "hit,down,comment,oneline,trackback,score1,score2,singo,point1,point2,point3,point4,d_regis,d_modify,d_comment,d_trackback,upload,ip,agent,sns,adddata,add_int1,add_int2,add_int3,add_int4,add_int5,add_int6,add_int7,add_int8,add_int9,add_int10,add_txt1,add_txt2,add_txt3,add_txt4,add_txt5,add_txt6,add_txt7,add_txt8,add_txt9,add_txt10,add_txt11,add_txt12,add_txt13";
		$QVAL = "'$s','$gid','$bbsuid','$bbsid','$depth','$parentmbr','$display','$hidden','$notice','$name','$nic','$mbruid','$id','$pw','$category','$subject','$content','$html','$tag',";
		$QVAL.= "'0','0','0','0','0','0','0','0','$point1','$point2','$point3','$point4','$d_regis','','','','$upload','$ip','$agent','','$adddata','$add_int1','$add_int2','$add_int3','$add_int4','$add_int5','$add_int6','$add_int7','$add_int8','$add_int9','$add_int10','$add_txt1','$add_txt2','$add_txt3','$add_txt4','$add_txt5','$add_txt6','$add_txt7','$add_txt8','$add_txt9','$add_txt10','$add_txt11','$add_txt12','$add_txt13'";
	...
	{	
		...
		$QVAL = "display='$display',hidden='$hidden',notice='$notice',category='$category',subject='$subject',content='$content',html='$html',tag='$tag',point3='$point3',point4='$point4',d_modify='$d_regis',upload='$upload',adddata='$adddata',add_int1='$add_int1',add_int1='$add_int1',add_int2='$add_int2',add_int3='$add_int3',add_int4='$add_int4',add_int5='$add_int5',add_int6='$add_int6',add_int7='$add_int7',add_int8='$add_int8',add_int9='$add_int9',add_int10='$add_int10',add_txt1='$add_txt1',add_txt2='$add_txt2',add_txt3='$add_txt3',add_txt4='$add_txt4',add_txt5='$add_txt5',add_txt6='$add_txt6',add_txt7='$add_txt7',add_txt8='$add_txt8',add_txt9='$add_txt9',add_txt10='$add_txt10',add_txt11='$add_txt11',add_txt12='$add_txt12',add_txt13='$add_txt13'";
