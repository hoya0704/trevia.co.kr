...
add_int1		INT(11)			NOT NULL,
add_int2		INT(11)			NOT NULL,
add_int3		INT(11)			NOT NULL,
add_int4		INT(11)			NOT NULL,
add_int5		INT(11)			NOT NULL,
add_int6		INT(11)			NOT NULL,
add_int7		INT(11)			NOT NULL,
add_int8		INT(11)			NOT NULL,
add_int9		INT(11)			NOT NULL,
add_int10		INT(11)			NOT NULL,
add_txt1		TEXT			NOT NULL,
add_txt2		TEXT			NOT NULL,
add_txt3		TEXT			NOT NULL,
add_txt4		TEXT			NOT NULL,
add_txt5		TEXT			NOT NULL,
add_txt6		TEXT			NOT NULL,
add_txt7		TEXT			NOT NULL,
add_txt8		TEXT			NOT NULL,
KEY site(site),
KEY gid(gid),
KEY bbs(bbs),
KEY bbsid(bbsid),
