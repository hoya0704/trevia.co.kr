<div id="cwrite" class="<?php echo $type=='modify'?'md':'wr'?>box">
	...
	<div class="box">
		...
		<div class="editbox">
			<input type="hidden" name="html" id="editFrameHtml" value="<?php echo $R['html']?$R['html']:'TEXT'?>" />
		...
		<div class="bottom">
			...
			<div class="r">
				<?php if($type=='modify'):?>
				<span><input class="btngray" type="submit" value="수정" alt="의견등록" /></span>
				<?php else:?>
				<span><input class="btngray" type="submit" value="댓글 등록" alt="의견등록" /></span>
				<?php endif?>
				<?php if($type=='modify'):?>
				<span><input class="btngray" type="submit" value="돌아가기" onclick="history.back();" alt="취소" /></span>
				<?php endif?>
			</div>
			<div class="clear"></div>
		</div>
